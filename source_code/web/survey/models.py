...
class Survey(models.Model):
	...
	active = models.BooleanField(default=False)  # if active student can answer the survey
	modify = models.BooleanField(default=True)  # if modify instructor can modify the survey
	...
	def get_question_by_index(self, question_index):
		...
		return self.question_set.filter(question_index=question_index).first()
