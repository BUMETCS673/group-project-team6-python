...
class test_weight(unittest.TestCase):
    ...
    def test01_change_weight_for_question1(self):
        ...
        self.survey_1.questions[0].weight = 5
        test_instance2 = Instance(40, students_target=self.students_target, num_team=num_of_team,
                                  survey_target=self.survey_1)
        num_of_times_running = 20
        flag2 = 0
        for j in range(0, num_of_times_running):
            result = test_instance2.run_instance()
            for i in range(0, num_of_team):
                if result[i].get_total_score() >= test_instance2.scores_after_random_assign[i]:
                    flag2 += 1

        self.assertTrue((flag2 / num_of_times_running) >= 0.8)

    def test02_change_weight_for_question2(self):
    ...
    def test03_change_weight_for_question3(self):
        self.survey_1.questions[2].weight = -5
        num_of_team = 3
        test_instance1 = Instance(40, students_target=self.students_target, num_team=num_of_team,
                                  survey_target=self.survey_1)
        num_of_times_running = 20
    ...
    def test04_change_weight_for_question4(self):
        self.survey_1.questions[3].weight = -5
        num_of_team = 3
        test_instance1 = Instance(40, students_target=self.students_target, num_team=num_of_team,
                                  survey_target=self.survey_1)
        num_of_times_running = 20
    ...
    def test05_change_weight_for_question5(self):
        self.survey_1.questions[4].weight = -5
        num_of_team = 3
        test_instance1 = Instance(40, students_target=self.students_target, num_team=num_of_team,
                                  survey_target=self.survey_1)
        num_of_times_running = 20
    ...
    def test06_change_weight_for_question6(self):
        self.survey_1.questions[5].weight = -5
        num_of_team = 3
        test_instance1 = Instance(40, students_target=self.students_target, num_team=num_of_team,
                                  survey_target=self.survey_1)
        num_of_times_running = 20
